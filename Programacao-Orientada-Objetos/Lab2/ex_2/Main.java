...
public class Main {
    public static void main(String[] args) {
        ...
        Produto produto1 = new Produto(); // Apenas código
        Produto produto2 = new Produto("Jogo de Tabuleiro");
        Produto produto3 = new Produto("Bola de Futebol", 15);
        Produto produto4 = new Produto("Camisa Esportiva", 20, "Vestuário", 99.90f);
        ...
        Produto produtoTeste = new Produto("Smartphone", 0, "Eletrônico", 1999.99f);
